...
form{
    ...
    <div class="ap">
        ...
        <form method="post"  name="tcredit">
            ...
            ?>
            <label style="color: black;"> <h3>From
                    <?php echo $res['UserName'] ;?></h3> </label>
                    <h5>Your details-</h5>
                    <h5>Email: <?php echo $res['Email'] ;?></h5> 
                    <h5>Contact Number: <?php echo $res['Contact'] ;?></h5> 
                    <h5>Credit Balance: <?php echo $res['Credits'] ;?></h5>
            ...
            <div class="input-field">
                        ...
                        <input  type="number" step="any" min="0" name="amount" required  />
